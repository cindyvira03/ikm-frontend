...
import { updateOutlet, getOutletById } from "@/services/ikmService"
...
export default function EditOutletPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setLokasiGooglemap(data.lokasi_googlemap || "")
        setDistrictId(data.kecamatan || "")

        if (data.foto_lokasi_tampak_depan) {
          setCurrentImage(
            `${process.env.NEXT_PUBLIC_STORAGE_URL}/${data.foto_lokasi_tampak_depan}`
          )
        }
  ...
  return (
    ...
    <div className="container-fluid mt-4 py-3 pb-5">
      ...
      <div className="mb-4">
        <h2 className="mb-0">Edit Outlet</h2>
        <p className="text-secondary">Ubah informasi outlet</p>
      </div>
            ...
            <div className="card border-0 shadow-sm">
              ...
              <div className="card-body d-flex flex-column gap-2">
                ...
                <button
                  ...
                  onClick={() => router.push("/ikm/outlet")}
                >
                  Kembali
                </button>
